...
##############################################################
# added to verify key and nonce send by Rapasso SMTP service

def verify_key(b64nonce, b64key):
    secret_key = settings.MAILIN_SECRET_KEY
    api_key = settings.MAILIN_API_KEY
    nonce = base64.b64decode(b64nonce)
    key = base64.b64decode(b64key)
    unique_key = secret_key+nonce
    cipher = Blowfish(unique_key)
    decrypted_api_key = cipher.decryptCTR(key)
